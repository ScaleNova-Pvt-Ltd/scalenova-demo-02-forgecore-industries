/**
 * System Validation Test Suite — ForgeCore Industries (DEMO-02)
...
console.log('\n\x1b[1m[ScaleNova DEMO-02] Validating ForgeCore Industries Production Integrity...\x1b[0m\n');

// 1. Pages check
const requiredPages = ["index.html","about.html","capabilities.html","manufacturing.html","engineering.html","industries.html","projects.html","quality-certifications.html","request-quote.html","insights.html","contact.html","privacy.html"];
...
assert(codeGs.includes('Demo 2 - Manufacturing'), 'Code.gs targets "Demo 2 - Manufacturing"');
assert(codeGs.includes('demo@scalenovasys.com'), 'Code.gs configures sender demo@scalenovasys.com');

console.log(`\nResults for ForgeCore Industries: ${passed} passed, ${failed} failed.\n`);
