...
| `demoId` | Demo ID | `custom_demo_id` | Data | e.g. `DEMO-02` |
| `submissionId` | Submission ID | `custom_submission_id` | Data | e.g. `SN-FOR-202609-1234` |
| `source` | Source | `source` | Select | "ScaleNova Demo — Manufacturing & Industrial SMEs" |
