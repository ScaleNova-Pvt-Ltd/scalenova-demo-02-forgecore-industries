# Google Sheets Intake Architecture — ForgeCore Industries
...
- **Assigned Worksheet**: `Demo 2 - Manufacturing`

## 2. Standard 23-Column Schema
Each row in `Demo 2 - Manufacturing` is stored with 23 standardized columns:

1. **Submission ID**: Unique deterministic key (e.g. `SN-FOR-202609-1234`)
2. **Created At**: ISO-8601 UTC timestamp
3. **Demo ID**: `DEMO-02`
4. **Industry**: `Manufacturing & Industrial SMEs`
5. **Client Name**: `ForgeCore Industries`
...
17. **Source**: `ForgeCore Industries Website`
