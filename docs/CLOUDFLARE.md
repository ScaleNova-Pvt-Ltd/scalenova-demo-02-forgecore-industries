# Cloudflare Workers Deployment Guide — ForgeCore Industries

## 1. Overview
ForgeCore Industries (`DEMO-02`) is engineered for sub-second global edge delivery via **Cloudflare Workers** with Static Assets.

- **Primary Custom Domain**: `https://demo2.scalenovasys.com`
- **Fallback URL**: `https://scalenova-demo-02-forgecore-industries.<account>.workers.dev`
...
3. Select **Connect to Git** and choose the repository:
   `ScaleNova-Pvt-Ltd/scalenova-demo-02-forgecore-industries`
...
2. Add custom domain: `demo2.scalenovasys.com`.
