# Frappe CRM Integration Specification — ForgeCore Industries

## 1. Operating Principle
ScaleNova connects public client frontends to the business operating system.
When a lead is submitted on `ForgeCore Industries`:
1. Ingested via Apps Script
2. Stored in Google Sheet (`Demo 2 - Manufacturing`)
